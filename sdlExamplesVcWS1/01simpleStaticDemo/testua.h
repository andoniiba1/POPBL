...
#define MATETARTE "Amaitu da klasea eta irakaslearen begiratu guztiak ekidin ez badituzu ere ez dizu abisu bat besterik eman. Emaitza ikusita arriskuak merezi izan du pena."
#define MATEGAIZKI "Amaitu da klasea eta irakaslearen begiratu guztiak ekidin ez badituzu ere ez dizu abisu bat besterik eman. Emaitza ikusita arriskuak merezi izan du pena."
#define MATEOSOGAIZKI "Jolasean ari zinela irakasleak bete betean harrapatu zaitu. Klasetik bota eta falta bat jarri duzu baina zure deskantsu pertsonalaz ari garenean ezerk ez zaitu geratuko. Gainera honelako kastigu batek ez du zu hurrengo klasera joatea ekidingo."
#define OINARRIAZALPENA "Aurreko oztopo gogor guztiak igaro eta gero Oinarri Metodologikoen ikasgaira iritsi zara. Uste dut momentua hau gure arteko sekretu batzuk azaltzeko egokia dela. Bueno ni hasiko naiz, klase honen amaieran duela bi aste bidalitako txostena entregatu beharra daukazu eta zure aurretik izan genuen hautagaiak ez zuen dokumentua sortu ere egin. Bueno zorte on ea klase amaierarako amaitzea lortzen duzun."
...
#define OINARRIGAIZKI "Zure txostena egiturari begiratuta desastre totala izan arren, estilo dezente bat mantentzeko gai izan zarenez baliteke gainditzea. Nik uste arro egoteko moduko lana dela."
...
#define PROGRAMAZALPENA "Programazioko klasean zaude eta beti bezala ilargian egon zara irakasleak azalpen guztiak eman dituenean. Eta hori honela ez dela eta klase osoa arretaz igaro duzula erakusteko asmoz galdera batzuk egitea erabaki duzu. Pertsonalki ez duk uste oso ideia ona denik baina ez naiz inor zure taktikak zalantzan jartzeko. Izan ere, ez dut uste nireak hobeak direnik. Bueno hobe duzu galdera hauek irakasleak azaldutako ezer ez izatea. Zorte on!"
...
#define PROGRAMTARTE "Galdera guztiak zuzenak izan ez badira ere ez duzu ridikulu totala egin eta hori zure galderak izan direla eta, eskertzekoa da. Ez dut uste ikasgaia gainditzeko nahikoa izango denik baina suerte puxkabatekin…"
#define PROGRAMGAIZKI "Galdera guztiak zuzenak izan ez badira ere ez duzu ridikulu totala egin eta hori zure galderak izan direla eta, eskertzekoa da. Ez dut uste ikasgaia gainditzeko nahikoa izango denik baina suerte puxkabatekin…"
#define PROGRAMOSOGAIZKI "Zorionak. Galdera egokiak egin dituzu. ... mmmm egia esan ez. Baina nik ere jolasteko aukera dut ez? Zure sentimenduekin soilik bada ere. Beste batean beharko du. Zu segi gogor ahalegintzen."
#define REDESAZALPENA "Iritsi zara asteko azken ikasgaira, badakit gogorra izan dela, baina zu lasai hau igaro ondoren etxean ordenagailua zure zain izango duzu eta. Ikasgai honetan gainera ez duzu lan gogorrik egin beharko izan ere irudian ikusiko dituzun kableak jarraituaz zein ordenagailu dauden elkarrekin konektatuta asmatu beharko duzu. Eta hau gogo apur batekin LH3-ko batek ere lortu dezake."
#define REDESONDO "Ez da oso lan gogorra izan baina ongi egin duzunez zoriondu egin beharko zaitut. ZORIONAK!"
#define REDESTARTE "Ez da oso lan gogorra izan baina ongi egin duzunez zoriondu egin beharko zaitut. ZORIONAK!"
...
#define FISIKAONDO "Zorionak! Kotxeak lerroa primeran jarraitu du eta proiektua gainditzea eskuratu duzu. Martxa honetan PoPBL-ra iristea lortuko duzu. Ez dago batere gaizki!"
...
#define FISIKAOSOGAIZKI "Zure ideia desastre bat izan da! Nola izango zenuen mando bat konektatzeko ideia. Orain zero bat edukitzeaz gain zure gelakide guztiek farre egiten dizute aurpegira. Baina informatiko baten bizitzan lagunik ez edukitzeak ez duenez gehiegi inporta ez da horrenbesteko arazoa izango. Zu lasai."
#define EGUNONA "Zorionak zure eguneko eginkizunen batezbestekoa begiratuta emaitza nahiko ona izan da. Honela jarraituaz gero PoPBL-raino iritsi zintezke hori bai informatikako titulua eskuratzea ez da lan erraza izango."
#define EGUNERTAINA "Ez dut uste inoiz informatikako titulua eskuratuko duzunik baina agian gogor ahaleginduaz gero hirugarren urterarte iritsi zintezke."
#define EGUNTXARRA "Espero nuen moduan zure eguna desastre bat izan da. Baina zu lasai unibertsitateaz gain beste bide batzuk ere badaude eta agian hurrengo steve jobs bilakatu zintezke."
#define ASTEONA ""
#define ASTEERTAINA ""
#define ASTETXARRA ""
char str[50][100];
